...
\end{equation}
Here, $y_1, \ldots y_n$ are $n$ observations of our response and are independent but not identically distributed, since the mean of $Y_i$ depends on the index $i$. We assume $Y_i \sim \poisson(\mu_i)$. Then:
\begin{equation}
...
\begin{enumerate}[beginpenalty=10000]
    ...
    \item We sample $y_i \sim \poisson(e^{\eta_i})$, $i = 1, \ldots, 100$.
\end{enumerate}
...
\begin{equation}
    r_i^P = \frac{y_i - \hat{\mu}_i}{\sqrt{\frac{\widehat{\Var(y_i)}}{\hat{\phi}}}}, \quad i = 1, \ldots, n.
\end{equation}
...
\begin{equation}
    r_i^P = \frac{y_i - e^{\xvec_i^\t\hat{\betavec}}}{\sqrt{e^{\xvec_i^\t\hat{\betavec}}}}, \quad i = 1, \ldots, n.
\end{equation}
