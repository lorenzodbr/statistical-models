...
\begin{proof}\leavevmode
    \begin{description}
        \item[Gaussian]
              ...
              and therefore:
              \begin{equation}
                  \theta_i = \mu_i\quad b(\theta_i) = \frac{\theta_i^2}{2}\quad \phi = \sigma^2\quad a_i(\phi) = \phi\quad c(y_i, \phi) = -\frac{1}{2}\frac{y_i^2}{\sigma^2} - \frac{1}{2}\log(2\pi\sigma^2).
              \end{equation}
        \item[Binomial]
              \begin{equation}
                  \begin{aligned}
              ...
              and therefore:
              \begin{equation}
                  \theta_i = \log\left(\frac{\pi_i}{1 - \pi_i}\right)\quad b(\theta_i) = -n_i \log(1 - \pi_i)\quad \phi = 1\quad a_i(\phi) = \phi\quad c(y_i, \phi) = \log\binom{n_i}{y_i}.
              \end{equation}
    \end{description}
\end{proof}
