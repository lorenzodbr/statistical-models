...
\begin{enumerate}
    ...
    \item Consider a logistic distribution, which has the following density function:
          ...
          \end{equation}
          We conclude that choosing $f = \bernoulli$ and $g = f^{-1}(z; 0, 1)$, we obtain the logistic regression. To write explicitly the link function, we have:
          \begin{equation}
              \mu_i = f(\eta_i; 1, 0) = \frac{e^{\eta_i}}{1 + e^{\eta_i}}
          \end{equation}
