...
We have seen a number of classifiers, such as \acs{lr}, \acs{lda}, \acs{qda}, Naive Bayes, $k$-NN. In this chapter, we will see how to choose the optimal model among a set of candidate models. We will also see how to estimate the test error rate of a model.
