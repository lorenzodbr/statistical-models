...
Consider the least squares estimator $\hat{\beta}_\textrm{LS}$ for one predictor, which is the solution of the optimization problem:
\begin{equation}
    X^\t(\Yvec - X\beta) = 0.
\end{equation}
...
\begin{itemize}
    \item $\begin{aligned}[t]
                  \beta_{\textsc{Lasso}} > 0 & \iff X^\t(\Yvec - X\beta_\textsc{Lasso}) = \frac{\lambda}{2}                                                              \\
                                                   ...
                                                   & \iff \beta_{\textsc{Lasso}} = \beta_\textrm{LS} - \frac{\lambda}{2} (X^\t X)^{-1}\negthinspace.
              \end{aligned}$
    \item $\begin{aligned}
                  \beta_{\textsc{Lasso}} < 0 & \iff X^\t(\Yvec - X\beta_{\textsc{Lasso}}) = -\frac{\lambda}{2} \iff \beta_{\textsc{Lasso}} = \beta_\textrm{LS} + \frac{\lambda}{2} (X^\t X)^{-1}\negthinspace.
              \end{aligned}$
    \item $\begin{aligned}[t]
                  \beta_{\textsc{Lasso}} = 0 & \iff X^\t(\Yvec - X\beta_{\textsc{Lasso}}) \in \left[-\frac{\lambda}{2}, \frac{\lambda}{2}\right]                                                              \\
                                                   ...
                                                   & \iff \beta_\textrm{LS} = (X^\t X)^{-1} X^\t \Yvec \in \left[-\frac{\lambda}{2} (X^\t X)^{-1}, \frac{\lambda}{2} (X^\t X)^{-1}\right].
              \end{aligned}$
\end{itemize}
