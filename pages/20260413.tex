...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}
        ...
        \draw[thick] (-3.25,-2.5) -- (-.75,0) -- (.75,0) -- (3.25,2.5);

        \draw[dashed] (-2.5,-2.5) -- (2.5,2.5);

        \node at (-1.1,0) [above] {\scriptsize $-\frac{\lambda}{2} (X^\t X)^{-1}$};
        \node at (1.1,0) [below] {\scriptsize $\frac{\lambda}{2} (X^\t X)^{-1}$};

        \draw[latex-latex] (1.5,.85) -- (1.5,1.45);
