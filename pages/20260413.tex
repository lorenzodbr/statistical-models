...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
Therefore, $\betavech_{\textsc{Ridge}} = A \betavech_{\text{LS}}$ where $A$ is a matrix that depends on $\lambda$ and $X\negthinspace$. We compute the expectation value of $\betavech_{\textsc{Ridge}}$ as:
\begin{equation}
    \E[\betavech_{\textsc{Ridge}}] = A \E[\betavech_{\text{LS}}] = (\oone + \lambda(X^\t X)^{-1})^{-1} \betavec.
\end{equation}
and the bias is:
\begin{equation}
    \begin{aligned}
...
\begin{itemize}
    \item $\begin{aligned}[t]
                  \beta_{\textsc{Lasso}} > 0 & \iff \Xvec^\t(\Yvec - \Xvec\beta_{\textsc{Lasso}}) = \frac{\lambda}{2}                                    \\
                                             ...
                                             & \iff \beta_{\textsc{Lasso}} = \beta_{\text{LS}} - \frac{\lambda}{2} (\Xvec^\t \Xvec)^{-1}\negthinspace.
              \end{aligned}$
    \item $\begin{aligned}
                  \beta_{\textsc{Lasso}} < 0 & \iff \Xvec^\t(\Yvec - \Xvec\beta_{\textsc{Lasso}}) = -\frac{\lambda}{2} \iff \beta_{\textsc{Lasso}} = \beta_{\text{LS}} + \frac{\lambda}{2} (\Xvec^\t \Xvec)^{-1}\negthinspace.
              \end{aligned}$
    \item $\begin{aligned}[t]
                  \beta_{\textsc{Lasso}} = 0 & \iff \Xvec^\t(\Yvec - \Xvec\beta_{\textsc{Lasso}}) \in \left[-\frac{\lambda}{2}, \frac{\lambda}{2}\right]                                     \\
                                             ...
                                             & \iff \beta_{\text{LS}} = (\Xvec^\t \Xvec)^{-1} \Xvec^\t \Yvec \in \left[-\frac{\lambda}{2} (\Xvec^\t \Xvec)^{-1}\negmedspace, \frac{\lambda}{2} (\Xvec^\t \Xvec)^{-1}\right].
              \end{aligned}$
\end{itemize}
...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}
        ...
        \node at (-1.1,0) [above] {\scriptsize $-\frac{\lambda}{2} (\Xvec^\t \Xvec)^{-1}$};
        \node at (1.1,0) [below] {\scriptsize $\frac{\lambda}{2} (\Xvec^\t \Xvec)^{-1}$};
