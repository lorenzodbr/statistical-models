...
\end{description}
The choice of $\gammavec$, $n$ and $\mu$ is important as it relates to the bias-variance trade-off. Again, \acs{cv} is needed for the selection of these parameters.
...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[domain=-1.75:1.75, samples=5000, thick] {x <= 1 ? 1 - x : 0};
        \end{axis}
    \end{tikzpicture}
