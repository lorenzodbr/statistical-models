...
\end{equation}
the only difference is the loss function. The loss function of \acsp{svc} is called \emph{hinge loss}, while the one of logistic regression is just the \emph{squared error loss}. So, \acsp{svm} use a different loss function:
\begin{equation}
