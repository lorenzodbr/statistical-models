...
\end{description}
The choice of $\gammavec, n, \mu$ is important as it relates to the bias-variance trade-off. Again, \acs{cv} is needed for the selection of these parameters.
...
The primal optimization problem of \acs{svc} is, as said before:
\begin{equation}
    \begin{aligned}
         & \min_{\beta_0, \betavec, \epsilonvec} \frac{1}{2}\norm{\betavec}^2                                     \\
