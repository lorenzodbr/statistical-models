...
\paragraph{Estimation of prior probabilities}
...
In this case we consider a multivariate extension of \acs{lda}. Therefore, the variables are now ${\Xvec = \tuple{x_1, \ldots, x_p}}$. Here, \acs{lda} assumes:
\begin{enumerate}
    ...
    \item $\Sigma_1 = \Sigma_2 = \cdots = \Sigma_K = \Sigma = \begin{pmatrix}
...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
which is indeed linear. Therefore, the $\xvec$s such that $\delta_1(\xvec) = \delta_2(\xvec)$ correspond to a \emph{linear decision surface}.
